...
class BarmanpayamakGateway extends GatewayAbstract {

	/**
	 * BarmanpayamakGateway constructor.
	 */
	public function __construct() {

		$this->webService  = config('sms.gateway.barmanpayamak.webService');
		$this->username    = config('sms.gateway.barmanpayamak.username');
		$this->password    = config('sms.gateway.barmanpayamak.password');
		$this->from        = config('sms.gateway.barmanpayamak.from');
	}
