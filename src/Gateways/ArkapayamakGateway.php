...
class ArkapayamakGateway extends GatewayAbstract {

	/**
	 * ArkapayamakGateway constructor.
	 */
	public function __construct() {

		$this->webService  = config('sms.gateway.arkapayamak.webService');
		$this->username    = config('sms.gateway.arkapayamak.username');
		$this->password    = config('sms.gateway.arkapayamak.password');
		$this->from        = config('sms.gateway.arkapayamak.from');
	}
