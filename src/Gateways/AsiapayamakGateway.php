...
class AsiapayamakGateway extends GatewayAbstract {
	...
	public function __construct() {
		...
		$this->webService  = config('sms.gateway.asiapayamak.webService');
		$this->username    = config('sms.gateway.asiapayamak.username');
		$this->password    = config('sms.gateway.asiapayamak.password');
		$this->from        = config('sms.gateway.asiapayamak.from');
	}
